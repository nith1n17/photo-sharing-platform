...
//         <button
//           type="submit"
//           className="w-full bg-black text-white rounded-lg py-3 hover:opacity-80"
//         >
//           Register
//         </button>
//       </form>
...
function Register() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-slate-100 overflow-hidden relative">
      ...
      {/* Gradient Orbs */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-green-100 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-blob" />
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 font-light text-sm tracking-wide">
              Join to start sharing your work
            </p>
          </div>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                value={username}
                onChange={(e) => setUsername(e.target.value)}
                className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent hover:border-slate-300"
                required
                disabled={loading}
              />
            </div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-slate-900 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            ...
            <p className="text-center text-sm text-slate-600 font-light">
              ...
              <a
                href="/login"
                className="font-semibold text-slate-900 hover:text-green-600 transition-colors duration-200"
              >
                Sign in
              </a>
            </p>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200/50">
            <p className="text-xs text-slate-600 font-light text-center leading-relaxed">
